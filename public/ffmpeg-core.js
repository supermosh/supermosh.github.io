var createFFmpegCore = (() => {
  ...
  return async function (createFFmpegCore = {}) {
    ...
    function _locateFile(path, prefix) {
      ...
      if (mainScriptUrlOrBlob) {
        const { wasmURL: wasmURL, workerURL: workerURL } = JSON.parse(
          atob(
            mainScriptUrlOrBlob.slice(mainScriptUrlOrBlob.lastIndexOf("#") + 1)
          )
        );
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module["asm"]["Aa"]).apply(
        null,
        arguments
      );
    };
    ...
    var ___cxa_is_pointer_type = function () {
      return (___cxa_is_pointer_type = Module["asm"]["Ea"]).apply(
        null,
        arguments
      );
    };
